...
public class TableManager {
    public static void crearTablas(Connection conexion) throws DAOException {
        try (Statement stmt = conexion.createStatement()) {
            ...
            String sqlTarea = "CREATE TABLE IF NOT EXISTS TAREA (TITULO VARCHAR(255) PRIMARY KEY, DESCRIPCION VARCHAR(255), HORAS_ESTIMADAS DOUBLE, HORAS_REALES DOUBLE, EMPLEADO_ASIGNADO VARCHAR(255))";
