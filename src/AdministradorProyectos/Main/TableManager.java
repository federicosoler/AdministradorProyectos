...
public class TableManager {
    public static void crearTablas(Connection conexion) throws DAOException {
        try (Statement stmt = conexion.createStatement()) {
            ...
            String sqlEmpleado = "CREATE TABLE IF NOT EXISTS EMPLEADO (NOMBRE VARCHAR(255) PRIMARY KEY, COSTO_HORA DOUBLE, ESTADO VARCHAR(255))";
            String sqlTarea = "CREATE TABLE IF NOT EXISTS TAREA (TITULO VARCHAR(255) PRIMARY KEY, DESCRIPCION VARCHAR(255), HORAS_ESTIMADAS DOUBLE, HORAS_REALES DOUBLE, EMPLEADO_ASIGNADO VARCHAR(255), ESTADO VARCHAR(50))";
            String sqlProyectoTarea = "CREATE TABLE IF NOT EXISTS PROYECTO_TAREA (PROYECTO_NOMBRE VARCHAR(255), TAREA_TITULO VARCHAR(255), PRIMARY KEY(PROYECTO_NOMBRE, TAREA_TITULO))";
